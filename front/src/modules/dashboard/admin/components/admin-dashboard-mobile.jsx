  ...
  return (
    <>
      ...
      <div onClick={() => setView(2)} className={`${view === 0 ? 'grid': 'hidden'} grid-rows-2 md:hidden rounded-xl shadow-lg mx-2 h-full hover:cursor-pointer`}>
        <div className='bg-greenDefault flex rounded-t-lg items-center p-2'>
      ...
      <div className={`${view === 1 ? 'flex' : 'hidden'} md:hidden flex-col gap-6`}>
        ...
        <div className='grid grid-rows-3 gap-4 px-2'>
          <Link to={'/admin/solicitud-mentorias'} className='p-6 h-44 grid items-center bg-greenDefault rounded-lg'>
          ...
          <Link to={'/admin/familias-voluntarias'} className='p-6 h-44 grid items-center bg-orangeDefault rounded-lg'>
      ...
      <div className={`${view === 2 ? 'flex' : 'hidden'} md:hidden flex-col gap-6`}>
        ...
        <div className='grid grid-rows-3 gap-4 px-2'>
          <Link to={'/admin/listado-familias'} className='p-6 h-44 grid items-center bg-greenDefault rounded-lg'>
